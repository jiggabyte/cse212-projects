...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:   Error Message: Assert.AreEqual failed. Expected:<Bob>. Actual:<Sue>.
    ...
    // Defect(s) Found: Error Message: Assert.AreEqual failed. Expected:<Tim>. Actual:<Sue>. 
